...
public class Eastersql {
    ...
    public List<Product> getProducts() {
        ...
        try {
            ...
            ResultSet rs = stmt.executeQuery("SELECT * FROM product_easter");
    ...
    public Product getProductById(int productId) {
        ...
        try {
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/giftsgalore", "root", "1234");
            Statement stmt = con.createStatement();
            String sql = "SELECT * FROM product_easter WHERE product_id = " + productId;
    ...
    public void addProduct(Product product) {
        try {
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/giftsgalore", "root", "1234");
            Statement stmt = con.createStatement();
            String sql = "INSERT INTO product_easter (product_name, price, description, buyer_name, review, ratings, imageUrl) VALUES ('"
