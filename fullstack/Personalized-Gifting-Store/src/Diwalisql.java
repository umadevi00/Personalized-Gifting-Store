...
public class Diwalisql {
    ...
    public List<Product> getProducts() {
        ...
        try {
            ...
            ResultSet rs = stmt.executeQuery("SELECT * FROM product_diwali");
    ...
    public Product getProductById(int productId) {
        ...
        try {
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/giftsgalore", "root", "1234");
            Statement stmt = con.createStatement();
            String sql = "SELECT * FROM product_diwali WHERE product_id = " + productId;
    ...
    public void addProduct(Product product) {
        try {
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/giftsgalore", "root", "1234");
            Statement stmt = con.createStatement();
            String sql = "INSERT INTO product_diwali (product_name, price, description, buyer_name, review, ratings, imageUrl) VALUES ('"
