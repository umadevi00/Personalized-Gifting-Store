...
<nav class="navbar navbar-expand-lg navbar-light navbar-main">
  ...
  <div class="container mt-5 text-center">
    ...
    <p>Find the perfect Birthday gift and celebrate.</p>
  </div>
  <!-- Carousel -->
