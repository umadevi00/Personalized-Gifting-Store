...
<head>
  ...
  <title>GiftsGalore - Fall Gifts</title>
...
<nav class="navbar navbar-expand-lg navbar-light navbar-main">
  ...
  <div class="container mt-5 text-center">
    <h1>Fall Gifts</h1>
    <p>Find the perfect Fall gift and celebrate.</p>
  </div>
  <!-- Carousel -->
