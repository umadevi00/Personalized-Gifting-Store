...
<%@page import="gifts.Valentinesql"%>
...
<head>
  ...
  <title>GiftsGalore - Valentine's Day Gifts</title>
...
<a class="navbar-brand" href="homepage.jsp">GiftsGalore</a>
  ...
  <div class="container mt-5 text-center">
    ...
    <p>Find the perfect Valentine's Day gift and celebrate.</p>
  </div>
  <!-- Carousel -->
