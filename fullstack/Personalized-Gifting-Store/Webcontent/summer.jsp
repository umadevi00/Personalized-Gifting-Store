...
<head>
  ...
  <title>GiftsGalore - Summer Gifts</title>
...
<nav class="navbar navbar-expand-lg navbar-light navbar-main">
  ...
  <div class="container mt-5 text-center">
    <h1>Summer Gifts</h1>
    <p>Find the perfect Summer gift and celebrate.</p>
  </div>
  <!-- Carousel -->
