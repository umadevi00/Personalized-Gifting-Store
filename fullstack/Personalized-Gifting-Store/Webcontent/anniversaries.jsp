...
<%@page import="gifts.Anniversarysql"%>
...
<head>
  ...
  <title>GiftsGalore - Anniversary Gifts</title>
...
<nav class="navbar navbar-expand-lg navbar-light navbar-main">
  ...
  <div class="container mt-5 text-center">
    ...
    <p>Find the perfect Anniversary gift and celebrate.</p>
  </div>
  <!-- Carousel -->
