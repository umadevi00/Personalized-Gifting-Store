...
<nav class="navbar navbar-expand-lg navbar-light navbar-main">
  ...
  <div class="accordion-container">
    <div class="accordion-card">
      <img class="background" src="https://cdn.igp.com/f_auto,q_auto,t_pnopt7prodlp/products/p-sunshine-serenade-bouquet-278923-m.jpg" alt="">
      <div class="card-content">
        <h3 class="title"><a href = "diwali.jsp">Diwali</a></h3>
      </div>
      <div class="backdrop"></div>
    </div>

    <div class="accordion-card">
      <img class="background" src="https://cdn.igp.com/f_auto,q_auto,t_pnopt7prodlp/products/p-rejuvenating-men-s-personal-care-kit-with-bouquet-285301-m.jpg" alt="">
      <div class="card-content">
        <h3 class="title"><a href = 'mothersday.jsp'>Mother's Day</a></h3>
      </div>
      <div class="backdrop"></div>
    </div>

    <div class="accordion-card">
      <img class="background" src="https://cdn.igp.com/f_auto,q_auto,t_prodm/products/p-photographic-memories-2-layer-bamboo-plant-with-pot-personalized-240949-m.jpg" alt="">
      <div class="card-content">
        <h3 class="title"><a href = 'birthday.jsp'>Birthdays</a></h3>
      </div>
      <div class="backdrop"></div>
    </div>

    <div class="accordion-card">
      <img class="background" src="https://cdn.igp.com/f_auto,q_auto,t_prodm/products/p-silver-grey-personalized-ball-pen-15280-m.jpg" alt="">
      <div class="card-content">
        <h3 class="title"><a href = 'summer.jsp'>Summer</a></h3>
      </div>
      <div class="backdrop"></div>
    </div>

    <div class="accordion-card">
      <img class="background" src="https://cdn.igp.com/f_auto,q_auto,t_prodm/products/p-ultimate-luxury-perfume-gift-set-for-men-20ml-each-283459-m.jpg" alt="">
      <div class="card-content">
        <h3 class="title"><a href = "valentine.jsp">Valentine's Day</a></h3>
      </div>
      <div class="backdrop"></div>
    </div>
  </div>
    ...
    <div class="row mt-5">
      ...
      <div class="col-md-3">
        <div class="card mb-4 shadow-sm highlight-on-hover">
          <a href="indexpagedetails.jsp?id=<%= product.getId() %>">
            <img class="card-img-top" src="<%= product.getImageUrl() %>" alt="<%= product.getName() %>">
          </a>
          <div class="card-body">
			  <h5 class="card-title"><%= product.getName() %></h5>
			  <p class="card-text">Price: $<%= product.getPrice() %></p>
			  <span class="rating">★ <%= product.getRatings() %></span> <!-- Display product ratings -->
			  <div class="d-flex justify-content-between align-items-center">
			  
			    <div class="btn-group">
			    	<button type="button" class="btn btn-sm btn-outline-secondary add-to-cart" data-product-id="<%= product.getId() %>">Add to Cart</button>
			    </div>
...
$(document).ready(function() {
  ...
  // Accordion Cards functionality
  const cardsContainer = document.querySelector(".accordion-container");
  cardsContainer.addEventListener("click", (e) => {
    const target = e.target.closest(".accordion-card");
    if (!target) return;
    cardsContainer.querySelectorAll(".accordion-card").forEach((card) => {
